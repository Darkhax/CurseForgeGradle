...
| disableVersionDetection () | Void                     | Invoking this method will disable automatic version detection for all files uploaded by this instance of the task.                                                                                                                                                                                                                                                       |
...
| addIncompatibility(slug) | String         | Marks the file as being incompatible with the specified project.                                                                                                                           |
| addRequirement(slug)     | String         | Marks the file as requiring a file from the specified project.                                                                                                                             |
| addEmbedded(slug)        | String         | Marks the file as containing an embedded implementation of another project.                                                                                                                |
| addTool(slug)            | String         | Marks the file as having a tool relation with the specified project.                                                                                                                       |
| addOptional(slug)        | String         | Marks the file as having an optional dependency on the specified project.                                                                                                                  |
| addModloader(modloader)  | String         | Adds a mod loader tag to the file. Known accepted values include Forge, Fabric, and Rift.                                                                                                  |
| addJavaVersion(version)  | String         | Marks the file as being compatible with a given Java version.                                                                                                                              |
| addGameVersion(version)  | String         | Adds a game version to the file. This can only be used on parent files.                                                                                                                    |
| addRelation(slug, type)  | String, String | Adds a relationship between the file and another project.                                                                                                                                  |
